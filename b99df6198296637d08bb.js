...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  formSubmit('[data-form="line"]', document.getElementById('formLineSuccess'), function () {});
  formSubmit('[data-form="callback"]', document.getElementById('formCallbackSuccess'), function () {});
  ...
  //         </svg>
  //         </div>
  //         <div class="result-modal__title">Запрос напрвлен!</div>
